                    ...
                    render: function (data, type, row) {
                        return '<div class="dropdown">' +
                            ...
                            '<div class="dropdown-menu dropdown-menu-end">' +
                                ...
                                '<a href="#" class="dropdown-item text-danger"><span class="mdi mdi-delete"></span> Remove Person</a>' +
                                '<a href="#" class="dropdown-item text-danger"><span class="mdi mdi-delete"></span> Disable Account</a>' +
                                '<a href="#" class="dropdown-item"><span class="mdi mdi-account-edit"></span> Make Person Contract</a>' +
                                '<a href="#" class="dropdown-item"><span class="mdi mdi-account-edit"></span> Make Person Permanent</a>' +
