...
@section('title', 'Workers On Contract')
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#home-b1" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                                ...
                                <span class="d-none d-md-block" id="pending-count">List of Workers On Contract</span>
                            </a>
                        </li>
                    </ul>
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        dataTable = $('#pending-table').DataTable({
            ajax: {
                url: '{{ route("user.view-contract-workers") }}',
                dataSrc: 'contracts'
            },
            columns: [
                {
                    ...
                    render: function (data, type, row) {
                        return '<div class="dropdown">' +
                            ...
                            '<div class="dropdown-menu dropdown-menu-end">' +
                                ...
                                '<a href="#" class="dropdown-item"><span class="mdi mdi-sitemap-outline"></span> Make Person Permanent</a>' +
